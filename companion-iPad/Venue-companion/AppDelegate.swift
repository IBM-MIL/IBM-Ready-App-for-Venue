...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //Set the SDK mode Market vs QA for Production and Pre-Production
            ...
            MQALogger.startNewSessionWithApplicationKey("1g9fa463014fd85cf900be932e481f0c5e3c4916d5g0g1g349e0cf7")
        #endif
...
//        gai.logger.logLevel = GAILogLevel.Verbose  // remove before app release
        ...
        ApplicationDataManager.sharedInstance.fetchData()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ibm.mil.Venue_companion" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Venue_companion", withExtension: "momd")!
